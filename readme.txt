...
= 1.3.2.1=
* Bugfix : attachment uplaod

= 1.3.2 =
* Bugfix : Not ShortCode mode.
* Bugfix : Pageview Bugfix.
* New : Custom template support.
* New : Change of attachment upload UI.
* Security Release

= 1.3.1 =
* Update : korean langauge
* Bugfix : debug code delete
= 1.3 =
* New : UI Chagne
* New : Board management
* Update : Search form
* Bugfix : ShrotCode bugfix.
* Remove : Board permalink option.
