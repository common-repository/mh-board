...
<?php $mh_board_options = get_option('mh_board_options');?>
	...
	<div class="btnarea action clearfix">
		...
		<div class="alignright clearfix">
			...
			<?php endif;?>
			<a href="<?php echo site_url($pagename);?>" class="btn button"><?php echo __('List');?></a>
			<?php if(is_user_logged_in() && get_current_user_id() == get_the_author_meta('ID')):?>
				<a href="<?php echo mh_board_edit_link(get_the_ID());?>" class="btn button"><?php echo __('Edit');?></a>
				<a href="<?php echo mh_board_delete_link(get_the_ID());?>" id="delete_board" class="btn button"><?php echo __('Delete');?></a>
			...
			?>
			<a href="<?php echo wp_nonce_url(mh_board_reply_link(get_the_ID()),'_mh_board_nonce');?>" class="btn button"><?php echo __('Reply');?></a>
			<?php endif;?>
		</div>
